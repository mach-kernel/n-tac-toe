...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__16545){
var map__16547 = p__16545;
var map__16547__$1 = cljs.core.__destructure_map(map__16547);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16547__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16547__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16547__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16547__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__16550_16580 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__16551_16581 = null;
var count__16552_16582 = (0);
var i__16553_16583 = (0);
while(true){
if((i__16553_16583 < count__16552_16582)){
var vec__16565_16584 = chunk__16551_16581.cljs$core$IIndexed$_nth$arity$2(null,i__16553_16583);
var k_16585 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16565_16584,(0),null);
var cb_16586 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16565_16584,(1),null);
try{var G__16569_16587 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_16586.cljs$core$IFn$_invoke$arity$1 ? cb_16586.cljs$core$IFn$_invoke$arity$1(G__16569_16587) : cb_16586.call(null,G__16569_16587));
}catch (e16568){var e_16588 = e16568;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_16585,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_16588], 0));
}

var G__16589 = seq__16550_16580;
var G__16590 = chunk__16551_16581;
var G__16591 = count__16552_16582;
var G__16592 = (i__16553_16583 + (1));
seq__16550_16580 = G__16589;
chunk__16551_16581 = G__16590;
count__16552_16582 = G__16591;
i__16553_16583 = G__16592;
continue;
} else {
var temp__5804__auto___16593 = cljs.core.seq(seq__16550_16580);
if(temp__5804__auto___16593){
var seq__16550_16594__$1 = temp__5804__auto___16593;
if(cljs.core.chunked_seq_QMARK_(seq__16550_16594__$1)){
var c__5568__auto___16595 = cljs.core.chunk_first(seq__16550_16594__$1);
var G__16596 = cljs.core.chunk_rest(seq__16550_16594__$1);
var G__16597 = c__5568__auto___16595;
var G__16598 = cljs.core.count(c__5568__auto___16595);
var G__16599 = (0);
seq__16550_16580 = G__16596;
chunk__16551_16581 = G__16597;
count__16552_16582 = G__16598;
i__16553_16583 = G__16599;
continue;
} else {
var vec__16570_16600 = cljs.core.first(seq__16550_16594__$1);
var k_16601 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16570_16600,(0),null);
var cb_16602 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16570_16600,(1),null);
try{var G__16574_16603 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_16602.cljs$core$IFn$_invoke$arity$1 ? cb_16602.cljs$core$IFn$_invoke$arity$1(G__16574_16603) : cb_16602.call(null,G__16574_16603));
}catch (e16573){var e_16604 = e16573;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_16601,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_16604], 0));
}

var G__16605 = cljs.core.next(seq__16550_16594__$1);
var G__16606 = null;
var G__16607 = (0);
var G__16608 = (0);
seq__16550_16580 = G__16605;
chunk__16551_16581 = G__16606;
count__16552_16582 = G__16607;
i__16553_16583 = G__16608;
continue;
}
} else {
}
