...
var rewrite_clj$node$protocols$Node$tag$dyn_22294 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_22294(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_22297 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_22297(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_22300 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_22300(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_22305 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_22305(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_22309 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_22309(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_22315 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_22315(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22272_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__22272_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_22320 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_22320(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_22324 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_22324(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_22325 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_22325(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_22326 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_22326(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_22331 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_22331(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_22334 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_22334(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_22335 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_22335(node);
}
});
...
var map__22279 = cljs.core.meta(node);
var map__22279__$1 = cljs.core.__destructure_map(map__22279);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22279__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22279__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22279__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22279__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__22280,p__22281){
var vec__22282 = p__22280;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22282,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22282,(1),null);
var vec__22285 = p__22281;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22285,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22285,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__22288 = col_extent;
if((row_extent === (0))){
return (G__22288 + col);
} else {
return G__22288;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__22289 = rewrite_clj.node.protocols.children(node);
var G__22289__$1 = (((G__22289 == null))?null:cljs.core.first(G__22289));
if((G__22289__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__22289__$1);
}
} else {
