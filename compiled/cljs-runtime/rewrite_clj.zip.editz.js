...
return rewrite_clj.node.protocols.coerce((function (){var G__24821 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
...
var len__5769__auto___24865 = arguments.length;
var i__5770__auto___24866 = (0);
while(true){
if((i__5770__auto___24866 < len__5769__auto___24865)){
args__5775__auto__.push((arguments[i__5770__auto___24866]));

var G__24867 = (i__5770__auto___24866 + (1));
i__5770__auto___24866 = G__24867;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__24822_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__24822_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq24823){
var G__24824 = cljs.core.first(seq24823);
var seq24823__$1 = cljs.core.next(seq24823);
var G__24826 = cljs.core.first(seq24823__$1);
var seq24823__$2 = cljs.core.next(seq24823__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24824,G__24826,seq24823__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__24856 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__24856) : str_fn.call(null,G__24856));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__24857 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__24857) : str_fn.call(null,G__24857));
})()):null)));
...
var G__24860 = rewrite_clj.zip.base.tag(zloc);
var G__24860__$1 = (((G__24860 instanceof cljs.core.Keyword))?G__24860.fqn:null);
switch (G__24860__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__24858_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__24858_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__24859_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__24859_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24860__$1)].join('')));
...
var G__24862 = rewrite_clj.zip.base.tag(zloc);
var G__24862__$1 = (((G__24862 instanceof cljs.core.Keyword))?G__24862.fqn:null);
switch (G__24862__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__24861_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__24861_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24862__$1)].join('')));
