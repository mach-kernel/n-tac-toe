...
if(typeof x === 'string'){
var vec__43512 = zprint.zprint.determine_ending_split_lines(x);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43512,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43512,(1),null);
...
try{return ["\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__43519 = zprint.config.merge_deep.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325),true], null),options], 0));
var G__43520 = coll_str;
return (zprint.core.zprint_str_internal.cljs$core$IFn$_invoke$arity$2 ? zprint.core.zprint_str_internal.cljs$core$IFn$_invoke$arity$2(G__43519,G__43520) : zprint.core.zprint_str_internal.call(null,G__43519,G__43520));
})())].join('');
...
var vec__43533 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options,null], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?(function (){var vec__43536 = zprint.core.get_zipper(options,coll);
var form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43536,(0),null);
var line_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43536,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [form,options,line_end], null);
})():(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__43541 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43541,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43541,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43533,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43533,(1),null);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43533,(2),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__43562){
var vec__43564 = p__43562;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43564,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43564,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43575,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43575,(1),null);
...
var configure_errors = (cljs.core.truth_(new cljs.core.Keyword(null,"configured?","configured?",642178633).cljs$core$IFn$_invoke$arity$1(zprint.config.get_options()))?null:zprint.core.configure_all_BANG_());
var vec__43593 = zprint.config.config_and_validate.cljs$core$IFn$_invoke$arity$4("determine-options",null,zprint.config.get_options(),rest_options);
var actual_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43593,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43593,(1),null);
var errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43593,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__43604){
var vec__43606 = p__43604;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43606,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43606,(1),null);
...
var vec__43610 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43610,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43610,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43610,(2),null);
...
var vec__43632 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43632,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43632,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43632,(2),null);
var tuple = vec__43632;
...
var G__43980 = cljs.core.next(style_vec);
var G__43981 = ends_w_blanks_QMARK_;
var G__43982 = tuple;
var G__43983 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__43980;
previous_ends_w_blanks_QMARK_ = G__43981;
previous_tuple = G__43982;
out = G__43983;
continue;
}
break;
 ...
 */
zprint.core.real_le = (function zprint$core$real_le(real_le_length,p__43635){
var vec__43636 = p__43635;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43636,(0),null);
var element = vec__43636;
...
var len__5769__auto___43988 = arguments.length;
var i__5770__auto___43990 = (0);
while(true){
if((i__5770__auto___43990 < len__5769__auto___43988)){
args__5775__auto__.push((arguments[i__5770__auto___43990]));

var G__43992 = (i__5770__auto___43990 + (1));
i__5770__auto___43990 = G__43992;
continue;
} else {
}
break;
...
var vec__43643 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43643,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43643,(1),null);
...
var vec__43649 = zprint.zprint.determine_ending_split_lines(coll);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43649,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43649,(1),null);
...
var result = (function (){var G__43653 = zprint.core.parse_string_all_options(rest_options);
var G__43654 = zprint.core.zprint_str_internal;
var G__43655 = ":parse-string-all? call";
var G__43656 = rewrite_clj.zip.edn_STAR_.cljs$core$IFn$_invoke$arity$1(rewrite_clj.parser.parse_string_all(coll__$1));
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__43653,G__43654,G__43655,G__43656) : zprint.core.process_multiple_forms.call(null,G__43653,G__43654,G__43655,G__43656));
})();
...
var vec__43665 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43665,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43665,(1),null);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43665,(2),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq43639){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43640,G__43641,seq43639__$2);
}));
...
var i__5770__auto___44000 = (0);
while(true){
if((i__5770__auto___44000 < len__5769__auto___43999)){
args__5775__auto__.push((arguments[i__5770__auto___44000]));

var G__44001 = (i__5770__auto___44000 + (1));
i__5770__auto___44000 = G__44001;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq43695){
...
var args__5775__auto__ = [];
var len__5769__auto___44002 = arguments.length;
var i__5770__auto___44003 = (0);
while(true){
if((i__5770__auto___44003 < len__5769__auto___44002)){
args__5775__auto__.push((arguments[i__5770__auto___44003]));

var G__44004 = (i__5770__auto___44003 + (1));
i__5770__auto___44003 = G__44004;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq43726){
var G__43727 = cljs.core.first(seq43726);
var seq43726__$1 = cljs.core.next(seq43726);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43727,seq43726__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___44008 = arguments.length;
var i__5770__auto___44009 = (0);
while(true){
if((i__5770__auto___44009 < len__5769__auto___44008)){
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq43731){
var G__43732 = cljs.core.first(seq43731);
var seq43731__$1 = cljs.core.next(seq43731);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43732,seq43731__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___44013 = arguments.length;
var i__5770__auto___44014 = (0);
while(true){
if((i__5770__auto___44014 < len__5769__auto___44013)){
args__5775__auto__.push((arguments[i__5770__auto___44014]));

var G__44015 = (i__5770__auto___44014 + (1));
i__5770__auto___44014 = G__44015;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq43757){
var G__43758 = cljs.core.first(seq43757);
var seq43757__$1 = cljs.core.next(seq43757);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43758,seq43757__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__43802,form){
var vec__43805 = p__43802;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43805,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43805,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43805,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43805,(3),null);
var previous_newline_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43805,(4),null);
...
var vec__43813 = (cljs.core.truth_((function (){var and__5043__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43813,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43813,(1),null);
...
var G__44040 = cljs.core.next(sos);
var G__44041 = comment_QMARK_;
var G__44042 = (function (){var or__5045__auto__ = (!(empty_string_QMARK_));
if(or__5045__auto__){
return or__5045__auto__;
} else {
...
var G__44043 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__44040;
previous_comment_QMARK_ = G__44041;
start_interpolating_QMARK_ = G__44042;
out = G__44043;
continue;
}
break;
...
try{var vec__43885 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43885,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43885,(1),null);
var vec__43888 = zprint.zprint.determine_ending_split_lines(file_str__$1);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43888,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43888,(1),null);
...
var vec__43891 = (cljs.core.truth_((function (){var or__5045__auto__ = range_start__$1;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43891,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43891,(1),null);
...
var vec__43894 = (cljs.core.truth_((function (){var and__5043__auto__ = actual_start;
if(cljs.core.truth_(and__5043__auto__)){
return actual_end;
} else {
return and__5043__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43894,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43894,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43894,(2),null);
...
var vec__43897 = (cljs.core.truth_(range_output_QMARK_)?(function (){var actual_start__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(actual_end,(-1)))?actual_start:(function (){var x__5130__auto__ = actual_start;
...
var corrected_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43897,(0),null);
var corrected_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43897,(1),null);
