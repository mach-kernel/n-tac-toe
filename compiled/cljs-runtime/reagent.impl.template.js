...
var G__19488 = o;
reagent.impl.template.goog$module$goog$object.set(G__19488,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__19564__delegate = function (args){
...
while (G__19565__i < G__19565__a.length) {G__19565__a[G__19565__i] = arguments[G__19565__i + 0]; ++G__19565__i;}
  args = new cljs.core.IndexedSeq(G__19565__a,0,null);
} 
return G__19564__delegate.call(this,args);};
G__19564.cljs$lang$maxFixedArity = 0;
G__19564.cljs$lang$applyTo = (function (arglist__19567){
var args = cljs.core.seq(arglist__19567);
return G__19564__delegate(args);
});
...
var G__19489 = o;
reagent.impl.template.goog$module$goog$object.set(G__19489,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__19571__i < G__19571__a.length) {G__19571__a[G__19571__i] = arguments[G__19571__i + 0]; ++G__19571__i;}
  args = new cljs.core.IndexedSeq(G__19571__a,0,null);
} 
return G__19569__delegate.call(this,args);};
G__19569.cljs$lang$maxFixedArity = 0;
G__19569.cljs$lang$applyTo = (function (arglist__19572){
var args = cljs.core.seq(arglist__19572);
...
var G__19490 = props;
var G__19490__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19490,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__19490);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19490__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__19493 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19493,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__19493;
}
})(),id_class);
...
var G__19494 = (cljs.core.count(argv) - first_child);
switch (G__19494) {
case (0):
...
var vec__19501 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19501,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19501,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19501,(2),null);
...
var temp__5808__auto___19575 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19575 == null)){
} else {
var key_19576 = temp__5808__auto___19575;
(jsprops.key = key_19576);
}
...
var temp__5808__auto___19577 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19577 == null)){
} else {
var key_19578 = temp__5808__auto___19577;
(jsprops.key = key_19578);
}
...
var temp__5808__auto___19579 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___19579 == null)){
} else {
var key_19580 = temp__5808__auto___19579;
(jsprops.key = key_19580);
}
...
var temp__5808__auto___19581 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19581 == null)){
} else {
var key_19582 = temp__5808__auto___19581;
(jsprops.key = key_19582);
}
...
var temp__5808__auto___19583 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19583 == null)){
} else {
var key_19584 = temp__5808__auto___19583;
(jsprops.key = key_19584);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19520_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__19520_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__19521 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19521,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19521,(1),null);
...
break;
default:
var G__19586 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__19587 = compiler;
v = G__19586;
compiler = G__19587;
continue;
...
var G__19536 = tag;
var G__19536__$1 = (((G__19536 instanceof cljs.core.Keyword))?G__19536.fqn:null);
switch (G__19536__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template19546 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template19546 = (function (opts,id,fn_to_element,parse_fn,meta19547){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta19547 = meta19547;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template19546.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19548,meta19547__$1){
var self__ = this;
var _19548__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template19546(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta19547__$1));
}));

(reagent.impl.template.t_reagent$impl$template19546.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19548){
var self__ = this;
var _19548__$1 = this;
return self__.meta19547;
}));

(reagent.impl.template.t_reagent$impl$template19546.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template19546.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template19546.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template19546.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template19546.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template19546.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta19547","meta19547",885089423,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template19546.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template19546.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template19546");

(reagent.impl.template.t_reagent$impl$template19546.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template19546");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template19546.
 */
reagent.impl.template.__GT_t_reagent$impl$template19546 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template19546(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta19547){
return (new reagent.impl.template.t_reagent$impl$template19546(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta19547));
});

}

return (new reagent.impl.template.t_reagent$impl$template19546(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
