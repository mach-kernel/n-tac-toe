...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__22104_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22104_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__22104_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__22105){
var vec__22106 = p__22105;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22106,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22106,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__22109,s,color,element,idx){
var map__22110 = p__22109;
var map__22110__$1 = cljs.core.__destructure_map(map__22110);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22110__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22110__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22110__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__22113 = (function (){var or__5045__auto__ = color;
...
var fexpr__22112 = (function (){var G__22114 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__22114) : style_map.call(null,G__22114));
})();
return (fexpr__22112.cljs$core$IFn$_invoke$arity$1 ? fexpr__22112.cljs$core$IFn$_invoke$arity$1(G__22113) : fexpr__22112.call(null,G__22113));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__22115){
var vec__22116 = p__22115;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22116,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22116,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22116,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__22119){
var vec__22120 = p__22119;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22120,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22120,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22120,(2),null);
...
var G__22233 = cljs.core.next(ssv);
var G__22234 = (this_ssv == null);
var G__22235 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__22236 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__22233;
doing_nil_QMARK_ = G__22234;
last_elide = G__22235;
out = G__22236;
continue;
}
...
var vec__22141 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22141,(2),null);
...
var G__22239 = cljs.core.next(remaining_cvec);
var G__22240 = new_idx;
var G__22241 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__22239;
idx = G__22240;
out = G__22241;
continue;
}
...
var G__22245 = cljs.core.next(ss_vec);
...
var G__22247 = (pos + cljs.core.count(cljs.core.first(ss)));
var G__22248 = ((((same_style_QMARK_) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(initial_pos,pos))))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.add_length(current)));
ss_vec = G__22245;
current = G__22246;
pos = G__22247;
out = G__22248;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__22165,cursor_vec){
var vec__22166 = p__22165;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22166,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22166,(1),null);
var focus_vec = vec__22166;
...
var vec__22169 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22169,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22169,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__22177){
var vec__22178 = p__22177;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22178,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22178,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__22201,existing_count){
var vec__22202 = p__22201;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22202,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22202,(1),null);
...
return cljs.core.filterv((function (p1__22192_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__22192_SHARP_))));
...
var vec__22208 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22208,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22208,(1),null);
var cvec_element = vec__22208;
if((cvec_element == null)){
var G__22250 = cljs.core.next(cvec_nl);
var G__22251 = (idx + (1));
var G__22252 = start;
var G__22253 = out;
cvec_nl = G__22250;
...
var G__22254 = cljs.core.next(cvec_nl);
var G__22255 = (idx + (1));
var G__22256 = idx;
var G__22257 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__22254;
idx = G__22255;
start = G__22256;
out = G__22257;
...
var G__22258 = cljs.core.next(cvec_nl);
var G__22259 = (idx + (1));
var G__22260 = (idx + (1));
var G__22261 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__22258;
idx = G__22259;
start = G__22260;
out = G__22261;
...
var G__22262 = cljs.core.next(cvec_nl);
var G__22263 = (idx + (1));
var G__22264 = idx;
var G__22265 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__22262;
idx = G__22263;
start = G__22264;
out = G__22265;
...
var G__22266 = cljs.core.next(cvec_nl);
var G__22267 = (idx + (1));
var G__22268 = start;
var G__22269 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__22266;
idx = G__22267;
start = G__22268;
out = G__22269;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__22216_SHARP_,p2__22215_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__22215_SHARP_)){
return cljs.core.reduced(p1__22216_SHARP_);
} else {
return (p1__22216_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__22217,p__22218){
var vec__22219 = p__22217;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22219,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22219,(1),null);
var vec__22222 = p__22218;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22222,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22222,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__22226,cvec,focus_vec){
var map__22227 = p__22226;
var map__22227__$1 = cljs.core.__destructure_map(map__22227);
var options = map__22227__$1;
var map__22228 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22227__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__22228__$1 = cljs.core.__destructure_map(map__22228);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22228__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22228__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22228__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22225_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__22225_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
