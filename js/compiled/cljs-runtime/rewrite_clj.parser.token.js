...
var G__23323 = (i__5770__auto___23322 + (1));
i__5770__auto___23322 = G__23323;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__23285){
var vec__23286 = p__23285;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23286,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__23269_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__23269_SHARP_) : allowed_QMARK_.call(null,p1__23269_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__23269_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq23279){
var G__23280 = cljs.core.first(seq23279);
var seq23279__$1 = cljs.core.next(seq23279);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23280,seq23279__$1);
}));
