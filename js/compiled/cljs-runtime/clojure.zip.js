...
var G__22124 = clojure.zip.node(loc);
var fexpr__22123 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var G__22126 = clojure.zip.node(loc);
var fexpr__22125 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__22125.cljs$core$IFn$_invoke$arity$1 ? fexpr__22125.cljs$core$IFn$_invoke$arity$1(G__22126) : fexpr__22125.call(null,G__22126));
} else {
...
var fexpr__22127 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__22127.cljs$core$IFn$_invoke$arity$2 ? fexpr__22127.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__22127.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__22128 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22128,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22128,(1),null);
var vec__22131 = clojure.zip.children(loc);
var seq__22132 = cljs.core.seq(vec__22131);
var first__22133 = cljs.core.first(seq__22132);
var seq__22132__$1 = cljs.core.next(seq__22132);
var c = first__22133;
var cnext = seq__22132__$1;
var cs = vec__22131;
...
var vec__22134 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22134,(0),null);
var map__22137 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22134,(1),null);
var map__22137__$1 = cljs.core.__destructure_map(map__22137);
var path = map__22137__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22137__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22137__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22137__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22137__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22137__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__22150 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22150,(0),null);
var map__22153 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22150,(1),null);
var map__22153__$1 = cljs.core.__destructure_map(map__22153);
var path = map__22153__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22153__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__22154 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22153__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__22155 = cljs.core.seq(vec__22154);
var first__22156 = cljs.core.first(seq__22155);
var seq__22155__$1 = cljs.core.next(seq__22155);
var r = first__22156;
var rnext = seq__22155__$1;
var rs = vec__22154;
...
var vec__22157 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22157,(0),null);
var map__22160 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22157,(1),null);
var map__22160__$1 = cljs.core.__destructure_map(map__22160);
var path = map__22160__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22160__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22160__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__22161 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22161,(0),null);
var map__22164 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22161,(1),null);
var map__22164__$1 = cljs.core.__destructure_map(map__22164);
var path = map__22164__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22164__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22164__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__22172 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22172,(0),null);
var map__22175 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22172,(1),null);
var map__22175__$1 = cljs.core.__destructure_map(map__22175);
var path = map__22175__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22175__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22175__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__22181 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22181,(0),null);
var map__22184 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22181,(1),null);
var map__22184__$1 = cljs.core.__destructure_map(map__22184);
var path = map__22184__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22184__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__22188 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22188,(0),null);
var map__22191 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22188,(1),null);
var map__22191__$1 = cljs.core.__destructure_map(map__22191);
var path = map__22191__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22191__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__22195 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22195,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22195,(1),null);
...
var len__5769__auto___22230 = arguments.length;
var i__5770__auto___22231 = (0);
while(true){
if((i__5770__auto___22231 < len__5769__auto___22230)){
args__5775__auto__.push((arguments[i__5770__auto___22231]));

var G__22232 = (i__5770__auto___22231 + (1));
i__5770__auto___22231 = G__22232;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq22198){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22199,G__22200,seq22198__$2);
}));
...
var G__22238 = clojure.zip.rightmost(child);
loc__$1 = G__22238;
continue;
} else {
return loc__$1;
...
var vec__22211 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22211,(0),null);
var map__22214 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22211,(1),null);
var map__22214__$1 = cljs.core.__destructure_map(map__22214);
var path = map__22214__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22214__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22214__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22214__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22214__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__22243 = clojure.zip.rightmost(child);
loc__$1 = G__22243;
continue;
} else {
return loc__$1;
