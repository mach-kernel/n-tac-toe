...
var o12474 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12474["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12475 = temp__5802__auto____$1;
return (o12475["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11792__auto__ = f;
return (o__11792__auto__["toString"]).call(o__11792__auto__);
} else {
return "";
}
}catch (e12481){var _ = e12481;
return "";
}});
...
try{var o__11792__auto___12745 = t;
(o__11792__auto___12745["cljs$lang$ctorPrWriter"]).call(o__11792__auto___12745,t,writer);
}catch (e12487){var __12746 = e12487;
}
...
var char_code = (function (){var o__11792__auto__ = (new String(char$));
return (o__11792__auto__["charCodeAt"]).call(o__11792__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11792__auto__ = String;
return (o__11792__auto__["fromCharCode"]).call(o__11792__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12493 = num_code;
switch (G__12493) {
case (1):
return (185);
...
var o__11792__auto__ = String;
return (o__11792__auto__["fromCharCode"]).call(o__11792__auto__,superscript_code);
});
/**
...
}catch (e12501){var _e__11849__auto__ = e12501;
return false;
}})())){
...
var vec__12502 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12502,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12517){
var vec__12518 = p__12517;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12518,(0),null);
...
var G__12784 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12785 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12784;
remaining_tokens = G__12785;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12514){
...
var vec__12528 = cljs.core.split_with((function (p1__12527_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12527_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12528,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12528,(1),null);
...
var vec__12537 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12537,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12537,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12791 = cljs.core.rest(remaining_tokens);
var G__12792 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12791;
name_tokens = G__12792;
continue;
} else {
...
var vec__12569 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12569,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12569,(1),null);
var vec__12572 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12572,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12572,(1),null);
var vec__12575 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12575,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12575,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12575,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12575,(3),null);
...
var vec__12610 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12610,(4),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12620 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12620,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12620,(1),null);
var vec__12623 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12623,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12623,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12627 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12627) : devtools.munging.parse_fn_info_deep.call(null,G__12627));
})()));
}
} else {
return fn_info;
...
var G__12826 = (arity + (1));
var G__12827 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12645){
var vec__12646 = p__12645;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12646,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12646,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12651_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12651_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12652_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12652_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12829 = arguments.length;
var i__5770__auto___12830 = (0);
while(true){
if((i__5770__auto___12830 < len__5769__auto___12829)){
args__5775__auto__.push((arguments[i__5770__auto___12830]));

var G__12831 = (i__5770__auto___12830 + (1));
i__5770__auto___12830 = G__12831;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12660){
var vec__12661 = p__12660;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12661,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12654){
var G__12655 = cljs.core.first(seq12654);
var seq12654__$1 = cljs.core.next(seq12654);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12655,seq12654__$1);
}));
...
var map__12670 = options;
var map__12670__$1 = cljs.core.__destructure_map(map__12670);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12670__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12670__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12670__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12670__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12671 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12671,(5),null);
...
var o__11792__auto__ = f;
return (o__11792__auto__["getBasis"]).call(o__11792__auto__);
});
/**
...
}catch (e12674){var _e__11849__auto__ = e12674;
...
var _STAR_ = (function (accum,p__12690){
var vec__12691 = p__12690;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12691,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12691,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12699){
var vec__12700 = p__12699;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12700,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12700,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12700,(2),null);
...
var post_process = (function (p__12708){
var vec__12709 = p__12708;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12709,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12709,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12705_SHARP_){
return (obj[cljs.core.first(p1__12705_SHARP_)]);
}),sorted_matches);
