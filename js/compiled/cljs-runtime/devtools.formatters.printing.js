...
var len__5769__auto___12909 = arguments.length;
var i__5770__auto___12910 = (0);
while(true){
if((i__5770__auto___12910 < len__5769__auto___12909)){
args__5775__auto__.push((arguments[i__5770__auto___12910]));

var G__12911 = (i__5770__auto___12910 + (1));
i__5770__auto___12910 = G__12911;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12836){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12837,G__12838,seq12836__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12850_SHARP_){
return (!((cljs.core.meta(p1__12850_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12876__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12880){var _e__11849__auto__ = e12880;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12882){var _e__11849__auto__ = e12882;
return false;
}}
})())){
...
var _STAR_current_state_STAR__temp_val__12892 = devtools.formatters.state.get_current_state();
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12899__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
var temp__5802__auto___12932 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___12932)){
var managed_print_level_12933 = temp__5802__auto___12932;
var _STAR_print_level_STAR__orig_val__12901_12934 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12902_12935 = managed_print_level_12933;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12902_12935);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12900_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12900_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12901_12934);
}} else {
job_fn();
}
