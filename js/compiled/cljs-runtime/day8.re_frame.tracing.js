...
var G__53467 = clojure.zip.next(loc);
var G__53468 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(seen,node);
loc = G__53467;
seen = G__53468;
continue;
} else {
var G__53469 = clojure.zip.next(loc);
var G__53470 = seen;
loc = G__53469;
seen = G__53470;
continue;
...
var len__5769__auto___53471 = arguments.length;
var i__5770__auto___53472 = (0);
while(true){
if((i__5770__auto___53472 < len__5769__auto___53471)){
args__5775__auto__.push((arguments[i__5770__auto___53472]));

var G__53473 = (i__5770__auto___53472 + (1));
i__5770__auto___53472 = G__53473;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame.tracing.fn_body.cljs$lang$applyTo = (function (seq53451){
