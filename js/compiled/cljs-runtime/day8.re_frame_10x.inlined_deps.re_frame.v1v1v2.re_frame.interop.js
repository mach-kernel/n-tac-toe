...
return [(function (){var pred__16040 = cljs.core.instance_QMARK_;
var expr__16041 = reactive_val;
if(cljs.core.truth_((pred__16040.cljs$core$IFn$_invoke$arity$2 ? pred__16040.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__16041) : pred__16040.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__16041)))){
return "ra";
} else {
if(cljs.core.truth_((pred__16040.cljs$core$IFn$_invoke$arity$2 ? pred__16040.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__16041) : pred__16040.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__16041)))){
return "rc";
} else {
if(cljs.core.truth_((pred__16040.cljs$core$IFn$_invoke$arity$2 ? pred__16040.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__16041) : pred__16040.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__16041)))){
return "rx";
} else {
if(cljs.core.truth_((pred__16040.cljs$core$IFn$_invoke$arity$2 ? pred__16040.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__16041) : pred__16040.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__16041)))){
return "tr";
} else {
return "other";
}
