...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_18089 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_18089(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_18092 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_18092(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18093 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18093(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18094 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18094(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18095 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18095(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18096 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18096(reader);
}
});
...
var G__18112 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__18113 = s.append(c);
c = G__18112;
s = G__18113;
continue;
}
