...
args__5775__auto__.push((arguments[i__5770__auto___14105]));
...
var _STAR_print_newline_STAR__orig_val__13980_14109 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__13981_14110 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__13982_14111 = true;
var _STAR_print_fn_STAR__temp_val__13983_14112 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__13982_14111);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__13983_14112);

try{var _STAR_print_level_STAR__orig_val__13987_14113 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13989_14114 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13989_14114);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13987_14113);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__13981_14110);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__13980_14109);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq13976){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13976));
}));
...
var new_formatters = current_formatters.filter((function (p1__14021_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__14021_SHARP_)));
}));
...
var G__14023_14119 = f;
var target__11831__auto___14120 = G__14023_14119;
if(cljs.core.truth_(target__11831__auto___14120)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14023_14119)].join(''),"\n","target__11831__auto__"].join('')));
}

(target__11831__auto___14120["toString"] = (function (){
...
var G__14036_14122 = "%c%s";
var G__14037_14123 = "color:transparent";
var G__14038_14124 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__14036_14122,G__14037_14123,G__14038_14124) : f.call(null,G__14036_14122,G__14037_14123,G__14038_14124));
...
var vec__14054 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14054,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14054,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__14141__delegate = function (add_fmt,add_args){
...
var G__14141 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__14142__i = 0, G__14142__a = new Array(arguments.length -  1);
while (G__14142__i < G__14142__a.length) {G__14142__a[G__14142__i] = arguments[G__14142__i + 1]; ++G__14142__i;}
  add_args = new cljs.core.IndexedSeq(G__14142__a,0,null);
} 
return G__14141__delegate.call(this,add_fmt,add_args);};
G__14141.cljs$lang$maxFixedArity = 1;
G__14141.cljs$lang$applyTo = (function (arglist__14143){
var add_fmt = cljs.core.first(arglist__14143);
var add_args = cljs.core.rest(arglist__14143);
return G__14141__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq14047){
var G__14048 = cljs.core.first(seq14047);
var seq14047__$1 = cljs.core.next(seq14047);
var G__14051 = cljs.core.first(seq14047__$1);
var seq14047__$2 = cljs.core.next(seq14047__$1);
var G__14052 = cljs.core.first(seq14047__$2);
var seq14047__$3 = cljs.core.next(seq14047__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14048,G__14051,G__14052,seq14047__$3);
}));
...
var seq__14085 = cljs.core.seq(features);
var chunk__14086 = null;
var count__14087 = (0);
var i__14088 = (0);
while(true){
if((i__14088 < count__14087)){
var feature = chunk__14086.cljs$core$IIndexed$_nth$arity$2(null,i__14088);
...
var G__14148 = seq__14085;
var G__14149 = chunk__14086;
var G__14150 = count__14087;
var G__14151 = (i__14088 + (1));
seq__14085 = G__14148;
chunk__14086 = G__14149;
count__14087 = G__14150;
i__14088 = G__14151;
continue;
} else {
...
var c__5568__auto__ = cljs.core.chunk_first(seq__14085__$1);
var G__14154 = cljs.core.chunk_rest(seq__14085__$1);
var G__14155 = c__5568__auto__;
var G__14156 = cljs.core.count(c__5568__auto__);
var G__14157 = (0);
seq__14085 = G__14154;
chunk__14086 = G__14155;
count__14087 = G__14156;
i__14088 = G__14157;
continue;
} else {
var feature = cljs.core.first(seq__14085__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__14160 = cljs.core.next(seq__14085__$1);
var G__14161 = null;
var G__14162 = (0);
var G__14163 = (0);
seq__14085 = G__14160;
chunk__14086 = G__14161;
count__14087 = G__14162;
i__14088 = G__14163;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o14098 = temp__5802__auto__;
return (o14098["version"]);
} else {
return null;
}
})() == null);
