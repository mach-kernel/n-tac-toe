...
var G__12825 = devtools.prefs.pref(v);
v = G__12825;
continue;
} else {
return v;
...
}catch (e12764){var _e__11849__auto__ = e12764;
return false;
}})();
...
}catch (e12772){var _e__11849__auto__ = e12772;
return false;
}})();
...
}catch (e12775){var _e__11849__auto__ = e12775;
return false;
}}
}
});
...
var vec__12788 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12788,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12788,(1),null);
...
return cljs.core.some((function (p1__12795_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12795_SHARP_);
}),template);
});
