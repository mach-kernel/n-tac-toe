...
var G__24876 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__24876__$1 = (((G__24876 == null))?null:cljs.core.iterate((function (loc){
...
var G__24876__$2 = (((G__24876__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__24876__$1));
var G__24876__$3 = (((G__24876__$2 == null))?null:cljs.core.last(G__24876__$2));
if((G__24876__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__24876__$3);
}
} else {
return zloc;
}
...
var G__24889 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__24890 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__24889;
parent = G__24890;
continue;
} else {
var G__24891 = rewrite_clj.zip.move.right(zloc_map_value);
var G__24892 = parent;
loc = G__24891;
parent = G__24892;
continue;
...
var G__24895 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__24896 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__24895;
parent = G__24896;
continue;
} else {
var G__24897 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__24898 = parent;
loc = G__24897;
parent = G__24898;
continue;
...
var G__24881 = zloc;
var G__24881__$1 = (((G__24881 == null))?null:rewrite_clj.zip.move.down(G__24881));
var G__24881__$2 = (((G__24881__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__24881__$1,k));
if((G__24881__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__24881__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__24882 = zloc;
var G__24882__$1 = (((G__24882 == null))?null:rewrite_clj.zip.move.down(G__24882));
var G__24882__$2 = (((G__24882__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__24882__$1));
var G__24882__$3 = (((G__24882__$2 == null))?null:rewrite_clj.zip.move.down(G__24882__$2));
var G__24882__$4 = (((G__24882__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__24882__$3,k));
if((G__24882__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__24882__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__24883 = rewrite_clj.zip.move.down(zloc);
var G__24883__$1 = (((G__24883 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__24883));
if((G__24883__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__24883__$1);
}
})(),k);
