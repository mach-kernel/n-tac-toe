...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k23107,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k23107,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__23155){
var vec__23156 = p__23155;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23156,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23156,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this23110,other23111){
var self__ = this;
var this23110__$1 = this;
return (((!((other23111 == null)))) && ((((this23110__$1.constructor === other23111.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23110__$1.tag,other23111.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23110__$1.format_string,other23111.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23110__$1.wrap_length,other23111.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23110__$1.seq_fn,other23111.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23110__$1.children,other23111.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23110__$1.__extmap,other23111.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__23172 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__23172) : self__.seq_fn.call(null,G__23172));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k23107){
var self__ = this;
var this__5350__auto____$1 = this;
var G__23186 = k23107;
var G__23186__$1 = (((G__23186 instanceof cljs.core.Keyword))?G__23186.fqn:null);
switch (G__23186__$1) {
case "tag":
case "format-string":
case "wrap-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k23107);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__23106){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__23187 = cljs.core.keyword_identical_QMARK_;
var expr__23188 = k__5352__auto__;
if(cljs.core.truth_((pred__23187.cljs$core$IFn$_invoke$arity$2 ? pred__23187.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__23188) : pred__23187.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__23188)))){
return (new rewrite_clj.node.seq.SeqNode(G__23106,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23187.cljs$core$IFn$_invoke$arity$2 ? pred__23187.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__23188) : pred__23187.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__23188)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__23106,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23187.cljs$core$IFn$_invoke$arity$2 ? pred__23187.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__23188) : pred__23187.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__23188)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__23106,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23187.cljs$core$IFn$_invoke$arity$2 ? pred__23187.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__23188) : pred__23187.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__23188)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__23106,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23187.cljs$core$IFn$_invoke$arity$2 ? pred__23187.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__23188) : pred__23187.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__23188)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__23106,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__23106),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__23106){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__23106,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__23116){
var extmap__5385__auto__ = (function (){var G__23203 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__23116,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__23116)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23203);
} else {
return G__23203;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__23116),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__23116),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__23116),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__23116),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__23116),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),(function (p1__23206_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__23206_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),(function (p1__23218_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__23218_SHARP_);
}),children);
});
