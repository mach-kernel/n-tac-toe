...
var i_43550 = (self__.level + (1));
while(true){
if((i_43550 <= (new_level + (1)))){
(update[i_43550] = self__.header);

var G__43551 = (i_43550 + (1));
i_43550 = G__43551;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43552 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43552[i]));
} else {
x__$2.forward.push((((i < links_43552.length))?(links_43552[i]):null));
}

if((i < links_43552.length)){
(links_43552[i] = x__$2);
} else {
links_43552.push(x__$2);
}
...
var i_43558 = (0);
while(true){
if((i_43558 <= self__.level)){
var links_43559 = (update[i_43558]).forward;
if((x__$1 === (((i_43558 < links_43559.length))?(links_43559[i_43558]):null))){
(links_43559[i_43558] = (x__$1.forward[i_43558]));

var G__43560 = (i_43558 + (1));
i_43558 = G__43560;
continue;
} else {
var G__43561 = (i_43558 + (1));
i_43558 = G__43561;
continue;
}
} else {
...
var G__43569 = nx;
var G__43570 = (level__$1 - (1));
x = G__43569;
level__$1 = G__43570;
continue;
} else {
var G__43571 = x;
var G__43572 = (level__$1 - (1));
x = G__43571;
level__$1 = G__43572;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__43580 = nx;
var G__43581 = (level__$1 - (1));
x = G__43580;
level__$1 = G__43581;
continue;
} else {
var G__43582 = x;
var G__43583 = (level__$1 - (1));
x = G__43582;
level__$1 = G__43583;
continue;
}
