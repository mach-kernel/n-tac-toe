...
var len__5769__auto___12678 = arguments.length;
var i__5770__auto___12679 = (0);
while(true){
if((i__5770__auto___12679 < len__5769__auto___12678)){
args__5775__auto__.push((arguments[i__5770__auto___12679]));

var G__12680 = (i__5770__auto___12679 + (1));
i__5770__auto___12679 = G__12680;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq12521){
var G__12522 = cljs.core.first(seq12521);
var seq12521__$1 = cljs.core.next(seq12521);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12522,seq12521__$1);
}));
...
return cljs.core.some((function (p1__12531_SHARP_){
return (p1__12531_SHARP_ === object);
}),history__$1);
});
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__12543){
var vec__12544 = p__12543;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12544,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq12535){
var G__12536 = cljs.core.first(seq12535);
var seq12535__$1 = cljs.core.next(seq12535);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12536,seq12535__$1);
}));

devtools.formatters.state.seek_path_segment = (function devtools$formatters$state$seek_path_segment(var_args){
var args__5775__auto__ = [];
var len__5769__auto___12695 = arguments.length;
var i__5770__auto___12696 = (0);
while(true){
if((i__5770__auto___12696 < len__5769__auto___12695)){
args__5775__auto__.push((arguments[i__5770__auto___12696]));

var G__12697 = (i__5770__auto___12696 + (1));
i__5770__auto___12696 = G__12697;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__12565){
var vec__12566 = p__12565;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12566,(0),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq12556){
var G__12560 = cljs.core.first(seq12556);
var seq12556__$1 = cljs.core.next(seq12556);
var G__12561 = cljs.core.first(seq12556__$1);
var seq12556__$2 = cljs.core.next(seq12556__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12560,G__12561,seq12556__$2);
}));
