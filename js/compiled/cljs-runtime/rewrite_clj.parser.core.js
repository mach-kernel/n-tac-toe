...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__23370 = cljs.core.get_global_hierarchy;
return (fexpr__23370.cljs$core$IFn$_invoke$arity$0 ? fexpr__23370.cljs$core$IFn$_invoke$arity$0() : fexpr__23370.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__23375_SHARP_){
var _STAR_delimiter_STAR__orig_val__23380 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__23381 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__23381);

try{return rewrite_clj.parser.core.parse_next(p1__23375_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__23380);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___23455 = arguments.length;
var i__5770__auto___23456 = (0);
while(true){
if((i__5770__auto___23456 < len__5769__auto___23455)){
args__5775__auto__.push((arguments[i__5770__auto___23456]));

var G__23457 = (i__5770__auto___23456 + (1));
i__5770__auto___23456 = G__23457;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__23390){
var vec__23391 = p__23390;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23391,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq23382){
var G__23383 = cljs.core.first(seq23382);
var seq23382__$1 = cljs.core.next(seq23382);
var G__23385 = cljs.core.first(seq23382__$1);
var seq23382__$2 = cljs.core.next(seq23382__$1);
var G__23386 = cljs.core.first(seq23382__$2);
var seq23382__$3 = cljs.core.next(seq23382__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23383,G__23385,G__23386,seq23382__$3);
}));
...
var G__23433 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__23433)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__23433)){
...
return cljs.core.cons((function (){var G__23436 = rewrite_clj.reader.peek(reader);
switch (G__23436) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__23433)){
